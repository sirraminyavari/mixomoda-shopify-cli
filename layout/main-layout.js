...
const MainLayout = ({ storeId, children }) => {
    const favIconUrl = "https://images.squarespace-cdn.com/content/v1/5ee6be593dc49f4def5d0ef1/77e165c4-6286-4a57-9033-51eb38e95697/favicon.ico?format=100w";
    ...
    const robotoFontUrl = "http://fonts.googleapis.com/css?family=Roboto:400,100,100italic,300,300italic,400italic,500,500italic,700,700italic,900italic,900";
    ...
    return (
        <>
            <Head>
                ...
                <link rel="stylesheet" type="text/css" href={ robotoFontUrl }></link>
            </Head>
